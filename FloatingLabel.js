...
class FloatingLabel extends Textbox {
    ...
    getTemplate() {
        ...
        return function(locals) {
            ...
            const placeholderString = self.state.fieldFocused
                ? ''
                : self.state.placeholderString || locals.label;
            return (
                <TouchableWithoutFeedback
                    onPress={() => {
                        if (locals.editable === false) {
                    ...
                    <View style={formGroupStyle}>
                        ...
                        <TextInput
                            ...
                            placeholderTextColor={
                                locals.hasError
                                    ? locals.errorPlaceholderTextColor || 'red'
                                    : locals.placeholderTextColor || 'grey'
                            }
